...
public class TAMI_QuickSearch_ActiveWildFirePerimeter_Test extends BaseClass {
	...
	public TAMI_QuickSearch_ActiveWildFirePerimeter_Test() throws IOException {
		super();
	...
	public void functionalTest(Hashtable<String, String> testData, ITestContext context) throws Exception {
		try {
			...
			if (!endpointData.isEmpty()) {
				...
				quickSearch.ValidatePropFromLegend(testData, report);
			}
