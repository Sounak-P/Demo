...
public class TAMI_LayerValidation_ActiveWildFirePerimeter_Test extends BaseClass {
	...
	public TAMI_LayerValidation_ActiveWildFirePerimeter_Test() throws IOException {
		super();
	...
	public void functionalTest(Hashtable<String, String> testData, ITestContext context) throws Exception {
		try {
			...
			Search.ValidatePropFromLegend(testData, report);
			}
