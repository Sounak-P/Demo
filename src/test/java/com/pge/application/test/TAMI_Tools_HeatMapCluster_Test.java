...
public class TAMI_Tools_HeatMapCluster_Test extends BaseClass {
	...
	public TAMI_Tools_HeatMapCluster_Test() throws IOException {
		super();
	...
	public void functionalTest(Hashtable<String, String> testData, ITestContext context) throws Exception {
		try {
			...
			tools.HeatMapValidation(testData, report);
