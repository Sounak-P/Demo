...
public class TAMI_Tools_CasualMarkup_Test extends BaseClass {
	...
	public TAMI_Tools_CasualMarkup_Test() throws IOException {
		super();
	...
	public void functionalTest(Hashtable<String, String> testData, ITestContext context) throws Exception {
		try {
			report = extent.createTest(this.getClass().getSimpleName()).assignCategory("Tools");
			...
			toc.CasualMarkUpEdit(testData, report);

			/*
			 * tools.funcExpandBottomPanel(testData, report);
			 * 
			 * 
			 * tools.funcOpenSearch(testData, report); tools.funcStreetSearch(testData,
			 * report);
			 */
