...
public class TAMI_Tools_GasPlume_Test extends BaseClass {
	...
	public TAMI_Tools_GasPlume_Test() throws IOException {
		super();
	...
	public void functionalTest(Hashtable<String, String> testData, ITestContext context) throws Exception {
		try {
			...
			tools.funcOpenGasPlumeModelValidate(testData, report);
