...
public class TAMI_Tools_AddSquezePoint_Test extends BaseClass {
	...
	public TAMI_Tools_AddSquezePoint_Test() throws IOException {
		super();
	...
	public void functionalTest(Hashtable<String, String> testData, ITestContext context) throws Exception {
		try {
			...
			//toc.funcSearchLayer2(testData, report);

			tools.funcExpandBottomPanel(testData, report);
			
			tools.funcOpenNetworkTracingToolValidate(testData, report);
