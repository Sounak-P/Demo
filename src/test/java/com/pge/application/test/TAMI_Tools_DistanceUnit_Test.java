...
public class TAMI_Tools_DistanceUnit_Test extends BaseClass {
	...
	public TAMI_Tools_DistanceUnit_Test() throws IOException {
		super();
	...
	public void functionalTest(Hashtable<String, String> testData, ITestContext context) throws Exception {
		try {
			...
			tools.funcOpenDistanceUnit(testData, report);
