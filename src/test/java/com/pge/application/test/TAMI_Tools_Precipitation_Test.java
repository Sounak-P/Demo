...
public class TAMI_Tools_Precipitation_Test extends BaseClass {
	...
	public TAMI_Tools_Precipitation_Test() throws IOException {
		super();
	...
	public void functionalTest(Hashtable<String, String> testData, ITestContext context) throws Exception {
		try {
			...
			tools.openPrecipitationValidate(testData, report);
