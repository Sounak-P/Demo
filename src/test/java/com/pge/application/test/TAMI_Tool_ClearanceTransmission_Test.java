...
public class TAMI_Tool_ClearanceTransmission_Test extends BaseClass {
	...
	public TAMI_Tool_ClearanceTransmission_Test() throws IOException {
		super();
	...
	public void functionalTest(Hashtable<String, String> testData, ITestContext context) throws Exception {
		...
		//	data = new TAMI_EndPoint_Data(driver);
			...
			tools.funcClearanceFilter(testData, report);
